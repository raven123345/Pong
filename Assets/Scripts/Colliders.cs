    ...
    void Start()
    {
        ...
        switch (_Position)
        {
            case Position.Top:
                ...
                transform.position = new Vector3(transform.position.x, transform.position.y + (collider.size.y * 0.5f), 0);
                break;
            ...
            case Position.Left:
                ...
                transform.position = new Vector3(transform.position.x - (collider.size.x * 0.5f), transform.position.y, 0);
                break;
            case Position.Right:
